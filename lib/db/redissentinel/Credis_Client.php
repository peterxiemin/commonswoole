...
class Credis_Client {
     ...
     */
    public function __construct($host = '127.0.0.1', $port = 6379, $timeout = null, $persistent = 'true', $db = 0, $password = null)
    {
    ...
    public function __call($name, $args)
    {
        ...
        if($this->standalone)
        {
            ...
            $response = $this->read_reply($name); //执行sentinel操作byxiemin
