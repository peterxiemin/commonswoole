...
class RedisVersion300 extends RedisProfile
{
    ...
    public function getSupportedCommands()
    {
        return array(
            ...
            'DUMP' => '\lib\db\Predis\Command\KeyDump',
            'RESTORE' => '\lib\db\Predis\Command\KeyRestore',
            ...
            'INFO' => '\lib\db\Predis\Command\ServerInfoV26x',
            ...
            /* commands operating on the key space */
            'PTTL' => '\lib\db\Predis\Command\KeyPreciseTimeToLive',
            'PEXPIRE' => '\lib\db\Predis\Command\KeyPreciseExpire',
            'PEXPIREAT' => '\lib\db\Predis\Command\KeyPreciseExpireAt',
            'MIGRATE' => '\lib\db\Predis\Command\KeyMigrate',

            /* commands operating on string values */
            'PSETEX' => '\lib\db\Predis\Command\StringPreciseSetExpire',
            'INCRBYFLOAT' => '\lib\db\Predis\Command\StringIncrementByFloat',
            'BITOP' => '\lib\db\Predis\Command\StringBitOp',
            'BITCOUNT' => '\lib\db\Predis\Command\StringBitCount',

            /* commands operating on hashes */
            'HINCRBYFLOAT' => '\lib\db\Predis\Command\HashIncrementByFloat',

            /* scripting */
            'EVAL' => '\lib\db\Predis\Command\ServerEval',
            'EVALSHA' => '\lib\db\Predis\Command\ServerEvalSHA',
            'SCRIPT' => '\lib\db\Predis\Command\ServerScript',

            /* remote server control commands */
            'TIME' => '\lib\db\Predis\Command\ServerTime',
            'SENTINEL' => '\lib\db\Predis\Command\ServerSentinel',

            /* ---------------- Redis 2.8 ---------------- */

            /* commands operating on the key space */
            'SCAN' => '\lib\db\Predis\Command\KeyScan',

            /* commands operating on string values */
            'BITPOS' => '\lib\db\Predis\Command\StringBitPos',

            /* commands operating on sets */
            'SSCAN' => '\lib\db\Predis\Command\SetScan',

            /* commands operating on sorted sets */
            'ZSCAN' => '\lib\db\Predis\Command\ZSetScan',
            'ZLEXCOUNT' => '\lib\db\Predis\Command\ZSetLexCount',
            'ZRANGEBYLEX' => '\lib\db\Predis\Command\ZSetRangeByLex',
            'ZREMRANGEBYLEX' => '\lib\db\Predis\Command\ZSetRemoveRangeByLex',
            'ZREVRANGEBYLEX' => '\lib\db\Predis\Command\ZSetReverseRangeByLex',

            /* commands operating on hashes */
            'HSCAN' => '\lib\db\Predis\Command\HashScan',

            /* publish - subscribe */
            'PUBSUB' => '\lib\db\Predis\Command\PubSubPubsub',

            /* commands operating on HyperLogLog */
            'PFADD' => '\lib\db\Predis\Command\HyperLogLogAdd',
            'PFCOUNT' => '\lib\db\Predis\Command\HyperLogLogCount',
            'PFMERGE' => '\lib\db\Predis\Command\HyperLogLogMerge',

            /* remote server control commands */
            'COMMAND' => '\lib\db\Predis\Command\ServerCommand',
