...
namespace lib\db\Predis\Configuration;
...
class Options implements OptionsInterface
{
    ...
    {
        return array(
            'cluster' => 'lib\db\Predis\Configuration\ClusterOption',
            'connections' => 'lib\db\Predis\Configuration\ConnectionFactoryOption',
            'exceptions' => 'lib\db\Predis\Configuration\ExceptionsOption',
            'prefix' => 'lib\db\Predis\Configuration\PrefixOption',
            'profile' => 'lib\db\Predis\Configuration\ProfileOption',
            'replication' => 'lib\db\Predis\Configuration\ReplicationOption',
        );
    }
