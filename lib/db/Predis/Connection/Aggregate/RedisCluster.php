...
namespace lib\db\Predis\Connection\Aggregate;

use lib\db\Predis\Cluster\RedisStrategy as RedisClusterStrategy;
use lib\db\Predis\Cluster\StrategyInterface;
use lib\db\Predis\Command\CommandInterface;
use lib\db\Predis\Command\RawCommand;
use lib\db\Predis\Connection\FactoryInterface;
use lib\db\Predis\Connection\NodeConnectionInterface;
use lib\db\Predis\NotSupportedException;
