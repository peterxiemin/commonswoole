...
namespace lib\db\Predis;

use lib\db\Predis\Command\CommandInterface;
use lib\db\Predis\Command\RawCommand;
use lib\db\Predis\Command\ScriptCommand;
use lib\db\Predis\Configuration\Options;
use lib\db\Predis\Configuration\OptionsInterface;
use lib\db\Predis\Connection\AggregateConnectionInterface;
use lib\db\Predis\Connection\ConnectionInterface;
use lib\db\Predis\Connection\ParametersInterface;
use lib\db\Predis\Monitor\Consumer as MonitorConsumer;
use lib\db\Predis\Pipeline\Pipeline;
use lib\db\Predis\PubSub\Consumer as PubSubConsumer;
use lib\db\Predis\Response\ErrorInterface as ErrorResponseInterface;
use lib\db\Predis\Response\ResponseInterface;
use lib\db\Predis\Response\ServerException;
use lib\db\Predis\Transaction\MultiExec as MultiExecTransaction;
...
class Client implements ClientInterface
{
    ...
    protected function createPipeline(array $options = null, $callable = null)
    {
        if (isset($options['atomic']) && $options['atomic']) {
            $class = '\lib\db\Predis\Pipeline\Atomic';
        } elseif (isset($options['fire-and-forget']) && $options['fire-and-forget']) {
            $class = '\lib\db\Predis\Pipeline\FireAndForget';
        } else {
            $class = '\lib\db\Predis\Pipeline\Pipeline';
        }
