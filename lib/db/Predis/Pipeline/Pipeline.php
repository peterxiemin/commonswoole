...
namespace lib\db\Predis\Pipeline;

use lib\db\Predis\ClientContextInterface;
use lib\db\Predis\ClientException;
use lib\db\Predis\ClientInterface;
use lib\db\Predis\Command\CommandInterface;
use lib\db\Predis\Connection\Aggregate\ReplicationInterface;
